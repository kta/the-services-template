...
const DOMAIN_ACCESS_TOKEN_AUDIENCE = domainAccessTokenAudience('example_service')
...
app.use('/api/internal/*', internalAuth<{ Bindings: Bindings }>('ADMIN_TO_EXAMPLE_SERVICE_KEY'))
